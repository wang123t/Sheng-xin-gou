...
.login-wrap .loginform .content form .setting label input,
.login-wrap .loginform .content form .setting label span {
...
.login-wrap .loginform .content .call ul li img {
  display: block;
  height: 35px;
}
